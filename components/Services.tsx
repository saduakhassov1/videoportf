...
const services = [
  {
    ...
    description: 'Полный день, love story, клип в день свадьбы. От 30 000 ₽',
    features: ['До 12 часов съёмки', '2 камеры', 'Дрон', 'Фильм 10-15 мин'],
  },
  {
    icon: Briefcase,
    title: 'Рекламные ролики',
    description: 'Продакшн для брендов и бизнеса. От 50 000 ₽',
    features: ['Сценарий', 'Съёмка', 'Монтаж', 'Цветокоррекция'],
  },
  {
    icon: Music,
    title: 'Музыкальные клипы',
    description: 'Креативные концепции и реализация. От 40 000 ₽',
    features: ['Идея', 'Локации', 'Съёмка', 'Постпродакшн'],
  },
  {
    icon: Building2,
    title: 'Корпоративное видео',
    description: 'Отчётные ролики, презентации. От 35 000 ₽',
    features: ['Мероприятия', 'Интервью', 'Промо', 'Документалка'],
  },
  {
    icon: Camera,
    title: 'Love Story',
    description: 'Романтические мини-фильмы. От 20 000 ₽',
    features: ['1-2 локации', 'Кинематографика', 'Музыка', 'Цветокор'],
  },
  {
    icon: Clapperboard,
    title: 'Документальное',
    description: 'Истории, интервью, репортажи. От 25 000 ₽',
